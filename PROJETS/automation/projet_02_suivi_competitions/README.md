# Suivi des Compétitions Sportives

Système de gestion et suivi de compétitions sportives

---

## 🎯 Objectif du Projet

Créer une application pour organiser des tournois, suivre les matchs et calculer les classements
...
1. **Création de compétitions avec différents formats (poules, élimination directe)**
2. **Gestion des équipes et des joueurs**
3. **Enregistrement des matchs et des scores**
4. **Calcul automatique des classements**
5. **Statistiques des équipes et joueurs**
6. **Export des résultats et classements**
...
@dataclass
class Competition:
    id, nom, type, date_debut, date_fin, statut
...
@dataclass
class Equipe:
    id, nom, ville, entraineur, joueurs_ids
...
@dataclass
class Match:
    id, competition_id, equipe1_id, equipe2_id, score1, score2, date
...
@dataclass
class Classement:
    id, competition_id, equipe_id, points, matchs_joues, victoires, defaites
...
### Gestionnaire Competitions
**Description :** Gère les compétitions

**Fichier :** `src/services/gestionnaire_competitions.py`
...
### Calculateur Scores
**Description :** Calcule les scores et classements

**Fichier :** `src/services/calculateur_scores.py`
