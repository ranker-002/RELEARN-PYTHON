#!/usr/bin/env python3
"""
Service for managing gestionnaire competitions.
"""
...
class GestionnaireCompetitions:
    """Manages competition entities."""
    ...
    def _chemin_fichier(self) -> Path:
        return self.repertoire / "competitions.json"
    ...
    def creer(self, nom: str, metadata: dict = None) -> Competition:
    ...
    def get(self, item_id: str) -> Optional[Competition]:
