...
Système de génération de rapports avec templates Jinja2

---

## 🎯 Objectif du Projet

Créer un générateur de rapports professionnel avec moteur de templates
...
1. **Création de templates avec syntaxe Jinja2**
2. **Import de données depuis multiples sources**
3. **Transformations et filtres de données**
4. **Génération de rapports multi-formats (HTML, PDF, DOCX)**
5. **Sections conditionnelles et boucles dans les templates**
6. **Prévisualisation des rapports avant génération**
...
@dataclass
class Rapport:
    id, titre, template_id, donnees, date_creation
...
@dataclass
class Template:
    id, nom, contenu_jinja2, description, variables_requises
...
@dataclass
class Section:
    id, template_id, nom, contenu, condition
...
### Generateur
**Description :** Génère les rapports finaux

**Fichier :** `src/services/generateur.py`
...
### Moteur Template
**Description :** Gère les templates Jinja2

**Fichier :** `src/services/moteur_template.py`
