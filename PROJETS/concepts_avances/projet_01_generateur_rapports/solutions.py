#!/usr/bin/env python3
"""
Générateur de Rapports avec Décorateurs - Solutions Commentées
======================================
...
class Solution:
    ...
    def __init__(self):
        self.project_name = "Générateur de Rapports avec Décorateurs"
        self.module = "concepts_avances"
    
    def run(self):
        """Exécute la solution complète."""
        from solution.src.main import Projet01GenerateurRapportsApplication
        app = Projet01GenerateurRapportsApplication()
        app.run()
