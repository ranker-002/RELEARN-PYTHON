#!/usr/bin/env python3
"""
Service for managing transformateur.
"""
...
class Transformateur:
    ...
    def __init__(self, repertoire_donnees: str = "data"):
        ...
        self.items: Dict[str, Pipeline] = {}
        self._charger_donnees()
    
    def _chemin_fichier(self) -> Path:
        return self.repertoire / "pipelines.json"
    ...
    def creer(self, nom: str, metadata: dict = None) -> Pipeline:
    ...
    def get(self, item_id: str) -> Optional[Pipeline]:
