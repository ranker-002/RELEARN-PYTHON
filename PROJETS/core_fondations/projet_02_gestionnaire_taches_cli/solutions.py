#!/usr/bin/env python3
"""
Gestionnaire de Tâches CLI - Solutions Commentées
======================================
...
class Solution:
    ...
    def __init__(self):
        self.project_name = "Gestionnaire de Tâches CLI"
        self.module = "core_fondations"
    
    def run(self):
        """Exécute la solution complète."""
        from solution.src.main import Projet02GestionnaireTachesCliApplication
        app = Projet02GestionnaireTachesCliApplication()
        app.run()
