#!/usr/bin/env python3
"""
Service for managing statisticien.
"""
...
from models import JeuDeDonnees, Statut


class Statisticien:
    """Manages jeudedonnees entities."""
    ...
    def __init__(self, repertoire_donnees: str = "data"):
        ...
        self.items: Dict[str, JeuDeDonnees] = {}
        self._charger_donnees()
    
    def _chemin_fichier(self) -> Path:
        return self.repertoire / "jeudedonneess.json"
    ...
    def creer(self, nom: str, metadata: dict = None) -> JeuDeDonnees:
        """Create a new jeudedonnees."""
        item = JeuDeDonnees(
            id="",
            nom=nom,
    ...
    def get(self, item_id: str) -> Optional[JeuDeDonnees]:
        return self.items.get(item_id)
    
    def get_all(self) -> List[JeuDeDonnees]:
