# Constructeur de Réseau de Neurones

Outil pour créer et entraîner des réseaux de neurones simples

---

## 🎯 Objectif du Projet

Créer une interface pour concevoir, entraîner et utiliser des réseaux de neurones
...
1. **Construction visuelle du réseau (couches, neurones)**
2. **Configuration des fonctions d'activation**
3. **Import de datasets d'entraînement**
4. **Entraînement avec monitoring des métriques**
5. **Sauvegarde et chargement des modèles**
...
@dataclass
class Reseau:
    id, nom, couches_ids, fonction_perte, optimiseur
...
@dataclass
class Couche:
    id, reseau_id, type, nb_neurones, fonction_activation, ordre
...
@dataclass
class Entrainement:
    id, reseau_id, dataset_id, epochs, loss_history, accuracy
...
### Constructeur Reseau
**Description :** Construit le réseau

**Fichier :** `src/services/constructeur_reseau.py`
...
### Entraineur
**Description :** Entraîne le modèle
