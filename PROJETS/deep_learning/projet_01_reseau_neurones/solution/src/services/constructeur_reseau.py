#!/usr/bin/env python3
"""
Service for managing constructeur reseau.
"""
...
from models import Reseau, Statut


class ConstructeurReseau:
    """Manages reseau entities."""
    ...
    def __init__(self, repertoire_donnees: str = "data"):
        ...
        self.items: Dict[str, Reseau] = {}
        self._charger_donnees()
    
    def _chemin_fichier(self) -> Path:
        return self.repertoire / "reseaus.json"
    ...
    def creer(self, nom: str, metadata: dict = None) -> Reseau:
        """Create a new reseau."""
        item = Reseau(
            id="",
            nom=nom,
    ...
    def get(self, item_id: str) -> Optional[Reseau]:
        return self.items.get(item_id)
    
    def get_all(self) -> List[Reseau]:
