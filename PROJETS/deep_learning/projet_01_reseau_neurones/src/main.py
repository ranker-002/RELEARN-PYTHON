...
from services.constructeur_reseau import ConstructeurReseau
...
class Projet01ReseauNeurones:
    ...
    def __init__(self):
        ...
        self.service = ConstructeurReseau()
    ...
    def _setup_logging(self):
        ...
        return logging.getLogger("projet_01_reseau_neurones")
...
def main():
    """Point d'entrée."""
    parser = argparse.ArgumentParser(description="Réseau de Neurones")
    parser.add_argument("--version", action="version", version="%(prog)s 1.0.0")
    
    args = parser.parse_args()
    
    app = Projet01ReseauNeurones()
    try:
        app.run()
