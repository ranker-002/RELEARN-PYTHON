#!/usr/bin/env python3
"""
Service for managing classificateur.
"""
...
class Classificateur:
    ...
    def __init__(self, repertoire_donnees: str = "data"):
        ...
        self.items: Dict[str, Modele] = {}
        self._charger_donnees()
    
    def _chemin_fichier(self) -> Path:
        return self.repertoire / "modeles.json"
    ...
    def creer(self, nom: str, metadata: dict = None) -> Modele:
        """Create a new modele."""
        item = Modele(
            id="",
            nom=nom,
    ...
    def get(self, item_id: str) -> Optional[Modele]:
        return self.items.get(item_id)
    
    def get_all(self) -> List[Modele]:
