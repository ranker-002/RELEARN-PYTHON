...
Ce projet vous permet d'appliquer régression dans un projet réel et professionnel.

**Concepts clés:** Régression, Classification, Feature Engineering

**Outils:** scikit-learn, xgboost, pandas
