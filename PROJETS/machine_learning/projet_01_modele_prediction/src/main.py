...
class Projet01ModelePrediction:
    ...
    def _setup_logging(self):
        ...
        return logging.getLogger("projet_01_modele_prediction")
...
def main():
    """Point d'entrée."""
    parser = argparse.ArgumentParser(description="Modèle de Prédiction")
    parser.add_argument("--version", action="version", version="%(prog)s 1.0.0")
    
    args = parser.parse_args()
    
    app = Projet01ModelePrediction()
    try:
        app.run()
