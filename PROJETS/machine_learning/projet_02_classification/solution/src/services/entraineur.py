#!/usr/bin/env python3
"""
Service for managing entraineur.
"""
...
from models import Classificateur, Statut


class Entraineur:
    """Manages classificateur entities."""
    ...
    def __init__(self, repertoire_donnees: str = "data"):
        ...
        self.items: Dict[str, Classificateur] = {}
        self._charger_donnees()
    
    def _chemin_fichier(self) -> Path:
        return self.repertoire / "classificateurs.json"
    ...
    def creer(self, nom: str, metadata: dict = None) -> Classificateur:
        """Create a new classificateur."""
        item = Classificateur(
            id="",
            nom=nom,
    ...
    def get(self, item_id: str) -> Optional[Classificateur]:
        return self.items.get(item_id)
    
    def get_all(self) -> List[Classificateur]:
