...
Gestionnaire de sauvegardes avec planification et restauration

---

## 🎯 Objectif du Projet

Créer un système de sauvegarde automatique de fichiers et répertoires
...
1. **Sélection de fichiers et répertoires à sauvegarder**
2. **Planification des sauvegardes (fréquence, heure)**
3. **Compression et chiffrement des sauvegardes**
4. **Gestion des versions (rotation, rétention)**
5. **Restauration sélective ou complète**
6. **Notifications et rapports de sauvegarde**
...
@dataclass
class Sauvegarde:
    id, nom, chemins_sources, destination, taille, date_creation
...
@dataclass
class Planification:
    id, sauvegarde_id, frequence, heure, actif
...
@dataclass
class Fichier:
    id, sauvegarde_id, chemin, taille, hash_checksum
...
@dataclass
class Restauration:
    id, sauvegarde_id, date_restauaration, chemins_restauares, statut
...
**Description :** Crée et gère les sauvegardes

**Fichier :** `src/services/gestionnaire_sauvegardes.py`
...
### Planificateur
**Description :** Planifie les exécutions
