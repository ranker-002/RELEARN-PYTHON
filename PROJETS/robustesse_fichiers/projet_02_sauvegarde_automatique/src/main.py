...
from services.gestionnaire_sauvegardes import GestionnaireSauvegardes
...
class Projet02SauvegardeAutomatique:
    ...
    def __init__(self):
        ...
        self.service = GestionnaireSauvegardes()
    ...
    def _setup_logging(self):
        ...
        return logging.getLogger("projet_02_sauvegarde_automatique")
...
def main():
    """Point d'entrée."""
    parser = argparse.ArgumentParser(description="Sauvegarde Automatique")
    parser.add_argument("--version", action="version", version="%(prog)s 1.0.0")
    
    args = parser.parse_args()
    
    app = Projet02SauvegardeAutomatique()
    try:
        app.run()
