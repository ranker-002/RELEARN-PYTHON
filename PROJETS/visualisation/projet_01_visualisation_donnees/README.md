...
Outil de création de graphiques et visualisations

---

## 🎯 Objectif du Projet

Créer un générateur de visualisations interactives à partir de données
...
1. **Import de données multiples (CSV, JSON, Excel)**
2. **Choix de types de graphiques (barres, lignes, camemberts, etc.)**
3. **Personnalisation des styles et couleurs**
4. **Export en PNG, SVG, ou interactif (HTML)**
5. **Graphiques combinés et subplots**
6. **Templates de visualisations prédéfinis**
...
@dataclass
class Visualisation:
    id, nom, type, dataset_id, configuration, chemin_sortie
...
@dataclass
class Graphique:
    id, visualisation_id, type, donnees, options_style
...
@dataclass
class Style:
    id, nom, couleurs, taille, polices, theme
...
### Generateur Graphiques
**Description :** Génère les graphiques

**Fichier :** `src/services/generateur_graphiques.py`
...
### Customiseur
**Description :** Customise l'apparence

**Fichier :** `src/services/customiseur.py`
