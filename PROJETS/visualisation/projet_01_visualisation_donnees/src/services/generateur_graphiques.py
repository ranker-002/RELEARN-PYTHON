#!/usr/bin/env python3
"""
Service for managing generateur graphiques.
"""
...
class GenerateurGraphiques:
    """Manages visualisation entities."""
    ...
    def __init__(self, repertoire_donnees: str = "data"):
        ...
        self.items: Dict[str, Visualisation] = {}
        self._charger_donnees()
    
    def _chemin_fichier(self) -> Path:
        return self.repertoire / "visualisations.json"
    ...
    def creer(self, nom: str, metadata: dict = None) -> Visualisation:
    ...
    def get(self, item_id: str) -> Optional[Visualisation]:
        return self.items.get(item_id)
    
    def get_all(self) -> List[Visualisation]:
