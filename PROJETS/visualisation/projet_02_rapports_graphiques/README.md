...
Assembleur de rapports avec visualisations intégrées

---

## 🎯 Objectif du Projet

Créer des rapports complets combinant texte et visualisations
...
1. **Création de rapports multi-pages**
2. **Insertion de graphiques et tableaux**
3. **Mise en page professionnelle**
4. **Export PDF, HTML, ou présentation**
5. **Templates de rapports sectoriels**
6. **Génération automatique à partir de données**
...
class RapportGraphique:
    id, titre, auteur, date_creation, pages_ids
...
@dataclass
class Element:
    id, rapport_id, type, contenu, position_x, position_y
...
@dataclass
class Donnees:
    id, element_id, source, transformation
...
@dataclass
class Template:
    id, nom, secteur, mise_en_page, styles
...
### Assembleur Rapports
**Description :** Assemble les rapports

**Fichier :** `src/services/assembleur_rapports.py`
...
**Fichier :** `src/services/moteur_graphique.py`
