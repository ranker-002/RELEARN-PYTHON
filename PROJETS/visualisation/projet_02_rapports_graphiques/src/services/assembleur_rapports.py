#!/usr/bin/env python3
"""
Service for managing assembleur rapports.
"""
...
from models import RapportGraphique, Statut


class AssembleurRapports:
    """Manages rapportgraphique entities."""
    ...
    def __init__(self, repertoire_donnees: str = "data"):
        ...
        self.items: Dict[str, RapportGraphique] = {}
        self._charger_donnees()
    
    def _chemin_fichier(self) -> Path:
        return self.repertoire / "rapportgraphiques.json"
    ...
    def creer(self, nom: str, metadata: dict = None) -> RapportGraphique:
        """Create a new rapportgraphique."""
        item = RapportGraphique(
            id="",
            nom=nom,
    ...
    def get(self, item_id: str) -> Optional[RapportGraphique]:
        return self.items.get(item_id)
    
    def get_all(self) -> List[RapportGraphique]:
