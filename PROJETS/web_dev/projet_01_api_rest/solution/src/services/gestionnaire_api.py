#!/usr/bin/env python3
"""
Service for managing gestionnaire api.
"""
...
from models import Endpoint, Statut


class GestionnaireApi:
    """Manages endpoint entities."""
    ...
    def __init__(self, repertoire_donnees: str = "data"):
        ...
        self.items: Dict[str, Endpoint] = {}
        self._charger_donnees()
    
    def _chemin_fichier(self) -> Path:
        return self.repertoire / "endpoints.json"
    ...
    def creer(self, nom: str, metadata: dict = None) -> Endpoint:
    ...
    def get(self, item_id: str) -> Optional[Endpoint]:
