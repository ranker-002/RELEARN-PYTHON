...
Application de gestion de tâches avec interface web

---

## 🎯 Objectif du Projet

Créer une application web complète pour gérer des tâches
...
1. **Création, modification, suppression de tâches**
2. **Organisation par listes et catégories**
3. **Priorisation et dates d'échéance**
4. **Marquage comme complété/en cours**
5. **Rappels et notifications**
6. **Filtrage et recherche de tâches**
...
@dataclass
class Tache:
    id, titre, description, statut, priorite, date_echeance, liste_id
...
@dataclass
class Liste:
    id, nom, description, taches_ids, couleur
...
@dataclass
class Rappel:
    id, tache_id, date_rappel, message, actif
...
### Gestionnaire Taches
**Description :** Gère les tâches

**Fichier :** `src/services/gestionnaire_taches.py`
...
### Planificateur
**Description :** Planifie les rappels
