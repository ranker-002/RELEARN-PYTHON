# projet_02_application_todo

Le développement web crée des applications accessibles via navigateur.

---

## Introduction

Ce projet vous permet d'appliquer api rest dans un projet réel et professionnel.

**Concepts clés:** API REST, CRUD, Authentification

**Outils:** fastapi, sqlalchemy, uvicorn
