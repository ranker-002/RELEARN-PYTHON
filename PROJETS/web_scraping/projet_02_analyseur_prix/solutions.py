#!/usr/bin/env python3
"""
Analyseur de Prix E-commerce - Solutions Commentées
======================================
...
class Solution:
    ...
    def __init__(self):
        self.project_name = "Analyseur de Prix E-commerce"
        self.module = "web_scraping"
    
    def run(self):
        """Exécute la solution complète."""
        from solution.src.main import Projet02AnalyseurPrixApplication
        app = Projet02AnalyseurPrixApplication()
        app.run()


if __name__ == "__main__":
    print(f"""
=== Analyseur de Prix E-commerce ===
